      ...
      {loading ? (
        ...
        <div className="cards">
          {sorted.map((t) => {
            ...
            return (
              <div key={t.id} className={`card ${t.imageUrl ? "card-has-image" : ""} ${completed ? "card-completed" : ""}`} onClick={() => onSelect(t)}>
                {t.imageUrl && (
                  <div className="card-img-wrapper">
                    <img src={t.imageUrl} alt="" className="card-img" />
                  </div>
                )}
                <div className="card-body">
                  ...
                  {t.game?.name && (
                    <span className="card-game-badge">{t.game.name}</span>
                  )}
                  {truncatedDesc && (
